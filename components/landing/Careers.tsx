  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 min-h-85 flex flex-col justify-between gap-6 md:gap-8 items-center p-8 sm:p-16 lg:p-36 bg-linear-to-r from-[#3e090a] to-[#d11f22] rounded-[2rem]">
        <h2 className="text-3xl sm:text-4xl md:text-6xl text-center font-semibold text-white">
          {t("careers.title")}
        </h2>
        <p className="max-w-sm md:max-w-xl text-center text-white text-sm md:text-lg">
